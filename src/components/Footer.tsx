...
function Footer() {
  const quickLinks = [
    ...
    { label: 'شهادة تقدير', href: '#certificate' },
  ];
  ...
  return (
    <footer className="footer">
      <div className="footer-main">
        <div className="container">
          <div className="footer-content">
            {/* Left Column in RTL - Contact Info */}
            ...
            {/* Right Column in RTL - Logo, Description, Social Media */}
            <div className="footer-column footer-about">
              ...
              <div className="footer-social">
                ...
                <a href="#" className="social-icon social-icon-active" aria-label="Facebook">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="footer-bottom">
        ...
        جميع الحقوق محفوظة هذه هى شركتك 2023 &copy;.
        </p>
      </div>
    </footer>
  );
